...
jQuery("body").scroll();"function"===typeof a.initFX2&&a.initFX2();a.canPushState=!0;window.setTimeout(function(){a.myFilterFormHolder.find("."+a.openAndCloseFilterFormClass).first().click()},300)},a.millisecondsBetweenActionsShort)):a.myTableHolder.removeClass(a.loadingClass)},setHTMLAndTemplateRow:function(){a.profileStarter("setHTMLAndTemplateRow");null!==a.rowRawData&&(a.useJSON=!0);a.myFilterFormHolder=a.myTableHolder.find(a.filterFormHolderSelector).first();a.myFilterFormInner=a.myFilterFormHolder.find(a.filterFormInnerSelector).first();
