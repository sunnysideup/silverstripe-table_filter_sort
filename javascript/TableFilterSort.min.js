...
sectionFilterClassAppendix:"Filter",filterOptionsHolderClass:"tfs-filter-form-options",filterGroupClass:"tfs-filter-column",groupLabelClass:"tfs-group-label",sortLinkSelector:"a.sortable",sortAscClass:"sort-asc",sortDescClass:"sort-desc",init:function(b){a.holderNumber=b;a.myTableHolder=n;a.myFilterFormHolder=a.myTableHolder.find(a.filterFormHolderSelector).first();a.myFilterFormInner=a.myFilterFormHolder.find(a.filterFormInnerSelector).first();a.myTable=a.myTableHolder.find(a.tableSelector).first();
...
location.pathname;0<a.myRows.length&&window.setTimeout(function(){a.myTableHolder.addClass(a.loadingClass);a.debug&&console.profile("filterItemCollector");a.filterItemCollector();a.debug&&(console.profileEnd(),console.profile("tableHideColsWhichAreAllTheSame"));a.tableHideColsWhichAreAllTheSame();a.myTableHolder.removeClass(a.loadingClass);window.setTimeout(function(){a.debug&&(console.profileEnd(),console.profile("setTableWidth"));a.setTableWidth();a.myTableHolder.addClass(a.loadingClass);a.debug&&
...
a.myTableHolder.removeClass(a.loadingClass)},a.millisecondsBetweenActions)},a.millisecondsBetweenActions)},resetObjects:function(){a.myRows=a.myTable.find(a.rowSelector)},setTableWidth:function(){var b="<colgroup>";a.myTableHead.find("tr:first th:visible").each(function(a,d){d=jQuery(d);var e=d.width(),e=e+1+"px",f=d.outerWidth();b+='<col width="'+f+'" style="width: '+(f+"px")+'; " />';d.css("width",e)});b+="</colgroup>";a.myTable.prepend(b);a.myTableHead.width(a.myTable.width());a.myTableHolder.find(".tfspushdowndiv").remove();
jQuery('<div class="tfspushdowndiv"></div>').insertBefore(a.myTable)},filterItemCollector:function(){var b="",c="";a.myRows.each(function(d,e){jQuery(e).find(a.filterItemSelector).each(function(d,e){e=jQuery(e);b=e.text();c=e.attr("data-filter");0<b.trim().length&&("undefined"===typeof a.dataDictionary[c]&&(a.dataDictionary[c]={}),"undefined"===typeof a.dataDictionary[c].Options&&(a.dataDictionary[c].Options=[]),-1===a.dataDictionary[c].Options.indexOf(b)&&a.dataDictionary[c].Options.push(b))})})},
tableHideColsWhichAreAllTheSame:function(){var b=a.myTableHolder.find("."+a.commonContentHolderClass).attr("data-title"),c='<div class="'+a.commonContentHolderClass+'-inner">'+("undefined"!==typeof b?"<h3>"+b+"</h3>":"")+"<ul>",d=!1;Object.keys(a.dataDictionary).forEach(function(b,f){if(1===a.dataDictionary[b].Options.length){delete a.dataDictionary[b];d=!0;var m=!1;jQuery('span[data-filter="'+b+'"]').each(function(d,f){f=jQuery(f);m||""===f.html()||f.hasClass("ignore-content")||(c+="<li><strong>"+
b+":</strong> <span>"+f.html()+"</span></li>",m=!0);var h=f.parent();f.remove();if(h.is("li"))h.hide();else if(h.is("td")&&0===h.children().length){if(0===d){var g=h.parent("tr").children("td").index(h);a.myTable.find("th").eq(g).remove()}h.remove()}})}});c+="</ul></div>";d?a.myTableHolder.find("."+a.commonContentHolderClass).html(c):a.myTableHolder.find("."+a.commonContentHolderClass).remove()},dataDictionaryCollector:function(){Object.keys(a.dataDictionary).forEach(function(b,c){"undefined"===typeof a.dataDictionary[b].Options&&
(a.dataDictionary[b].Options=[]);var d=a.myTable.find(a.sortLinkSelector+'[data-sort-field="'+b+'"]').first();"undefined"===typeof a.dataDictionary[b].CanFilter&&(d&&"true"==d.attr("data-sort-only")?a.dataDictionary[b].CanFilter=!1:a.dataDictionary[b].CanFilter=1<a.dataDictionary[b].Options.length);"undefined"===typeof a.dataDictionary[b].CanSort&&(a.dataDictionary[b].CanSort=0<d.length);"undefined"===typeof a.dataDictionary[b].DataType&&a.dataDictionary[b].CanSort&&(d=d.attr("data-sort-type"),a.dataDictionary[b].DataType=
...
a.millisecondsBetweenActions)},a.millisecondsBetweenActions)},setupFilterFormListeners:function(){a.myFilterFormInner.hide();a.myFilterFormHolder.on("click","."+a.openAndCloseFilterFormClass,function(b){b.preventDefault();a.myFilterFormInner.slideToggle("fast",function(){a.hasFixedTableHeader&&a.myTableHead.css("top",a.myFilterFormHolder.outerHeight()+"px");a.myTableHolder.toggleClass(a.filterIsOpenClass);a.myTableHolder.hasClass(a.filterIsOpenClass)&&a.scrollToTopOfHolder()});return!1});a.myFilterFormHolder.on("click",
...
overlayClose:!0,onClose:function(){jQuery.modal.close();a.retrieveDataFromServer()}});return!1}).fail(function(){alert("ERROR!");a.myTable.removeClass(a.loadingClass)});return!1})},createFilterForm:function(){if(0<a.myFilterFormInner.length){a.myFilterFormInner.html("");var b=1,c=[],d='<form class="'+a.filterOptionsHolderClass+'">';Object.keys(a.dataDictionary).forEach(function(e,f){if(a.dataDictionary[e].CanFilter){b++;var l=0,h=a.dataDictionary[e].Options.length;if(1<h&&h<=a.maximumNumberOfFilterOptions){d+=
a.makeSectionHeaderForForm("checkbox",e);for(l=0;l<h;l++)d+=a.makeFieldForForm("checkbox",e,b,a.dataDictionary[e].Options[l]);d+=a.makeSectionFooterForForm()}else h>a.maximumNumberOfFilterOptions&&(l=a.dataDictionary[e].DataType,"string"===a.dataDictionary[e].DataType&&(c.push(e),l="tag"),d+=a.makeSectionHeaderForForm(l,e),d+=a.makeFieldForForm(l,e,b,0),d+=a.makeSectionFooterForForm())}});a.hasFavourites&&(d+=a.makeSectionHeaderForForm("favourites",a.favouritesCategoryTitle),d+=a.makeFieldForForm("favourites",
...
0;a.workOutCurrentFilter();a.startRowManipulation();window.setTimeout(function(){a.myRows.each(function(b,c){var d=jQuery(c),e=!0,f=!0;Object.keys(a.cfinc).forEach(function(b,c){if(f){for(var g=!1,h=!0,q=0;q<a.cfinc[b].length;q++){var k=a.cfinc[b][q];if(h){if(b===a.favouritesCategoryTitle){var r=d.attr("id");"undefined"!==typeof r&&0<r.length&&-1<a.myfavs.indexOf(r)&&(g=!0)}else if(b===a.keywordsCategoryTitle){for(var v=k.vtm,r=d.text().toLowerCase(),v=v.split(" "),n=!0,t=0;t<v.length;t++){var p=
v[t].trim();if(-1===r.indexOf(p)){n=!1;break}}!0===n&&(g=!0)}else d.find('span[data-filter="'+b+'"]').each(function(d,c){c=jQuery(c);var e=c.text().toLowerCase().trim();switch(a.dataDictionary[b].DataType){case "date":break;case "number":if("undefined"!==typeof k.vtm){var f=k.vtm;e==f&&(g=!0)}else{var e=parseFloat(e.replace(/[^0-9.]/g,"")),h=k.lt,f=!0;jQuery.isNumeric(h)&&0!==h&&h<e&&(f=!1);f&&(h=k.gt,jQuery.isNumeric(h)&&0!==h&&h>e&&(f=!1));f&&(g=!0);break}default:f=k.vtm,e===f&&(g=!0)}if(g)return!1});
g&&(h=!1)}}g||(f=e=!1)}});e?d.addClass(a.matchClass).removeClass(a.notMatchClass):d.addClass(a.notMatchClass).removeClass(a.matchClass)});a.endRowManipulation()},a.millisecondsBetweenActions)},gotoPage:function(b){a.showFromRow=b*a.visibleRowCount;a.startRowManipulation();a.endRowManipulation()},scrollToTopOfHolder:function(){jQuery("html, body").animate({scrollTop:a.myTableHolder.position().top},200)},fixTableHeader:function(){if(a.myTableHolder.isOnScreen()||a.myTableHolder.hasClass(a.filterIsOpenClass)){if(a.myTableHolder.addClass(a.filterInUseClass),
a.myTableHolder.removeClass(a.filterNotInUseClass),a.hasFixedTableHeader){var b=a.myTableHolder.hasClass(a.filterIsOpenClass)?!1:!0,c=a.myTableHead.outerHeight();b&&(c+=a.myFilterFormHolder.outerHeight());a.myTableHolder.find(".tfspushdowndiv").height(c);c=a.myTableBody.offset().top;!0===(jQuery(window).scrollTop()>c?!0:!1)?(c=a.myTableHolder.width(),b&&a.myFilterFormHolder.width(c),window.setTimeout(function(){a.myTableHolder.addClass(a.fixedHeaderClass);var d=0;b&&(d=a.myFilterFormHolder.outerHeight());
a.myTableHead.css("top",d)},a.millisecondsBetweenActions)):a.myTableHolder.removeClass(a.fixedHeaderClass)}}else a.myTableHolder.addClass(a.filterNotInUseClass),a.myTableHolder.removeClass(a.filterInUseClass)},startRowManipulation:function(){"function"===typeof a.startRowFX1&&a.startRowFX1(a);a.resetObjects();a.myTableHolder.addClass(a.loadingClass);a.myTableHolder.find(a.moreRowEntriesSelector).hide();a.myTable.hide();a.myRows.each(function(b,c){jQuery(c).addClass(a.hideClass).removeClass(a.showClass)});
...
var n=b+e,l=Math.ceil(d/a.visibleRowCount),h=Math.floor(a.showFromRow/a.visibleRowCount),q="";if(1<l){for(var k=0,r=0,v=h-2,p=h+2,t=[],k=0;k<l;k++)h===k?(r=0,q+="<span>["+(k+1)+"]</span>"):(test1=k>v&&k<p,test2=k>=l-1,test3=1>k,test1||test2||test3?(t=[],r=0,0===k&&t.push("first"),k===l-1&&t.push("last"),k===h-1&&t.push("prev"),k===h+1&&t.push("next"),q+='<a href="#" class="'+t.join(" ")+'"data-page="'+k+'">'+(k+1)+"</a> "):3>r&&(r++,q+=" . ")),q+=" ";a.myTableHolder.find(a.moreRowEntriesSelector).show()}b++;
a.myTableHolder.find(a.minRowSelector).text(b);a.myTableHolder.find(a.maxRowSelector).text(n);a.myTableHolder.find(a.matchRowCountSelector).text(d);a.myTableHolder.find(a.totalRowCountSelector).text(c);a.myTableHolder.find(a.visibleRowCountSelector).text(e);a.myTableHolder.find(a.paginationSelector).html(q);a.myTable.show();a.myTableHolder.removeClass(a.loadingClass);a.myTableHolder.hasClass(a.filterIsOpenClass)||window.setTimeout(a.scrollToTopOfHolder(),a.millisecondsBetweenActions);n=a.currentURL();
a.useBackAndForwardButtons&&history.pushState(null,null,n);"undefined"!==typeof Cookies&&Cookies.set("lastFilter",n,{path:a.baseURL,expires:180});a.resetObjects();"function"===typeof a.endRowFX2&&a.endRowFX2(a);a.fixTableHeader()},currentURL:function(){for(var b={},c=0;c<a.filterAndSortVariables.length;c++){var d=a.filterAndSortVariables[c];0<Object.keys(a[d]).length&&(b[d]=a[d])}b="undefined"!==typeof JSURL?JSURL.stringify(b):"tfs="+encodeURI(JSON.stringify(b));return a.baseURL+"#"+b},workOutCurrentFilter:function(){var b=
"",c,d="";a.cfinc={};a.myFilterFormHolder.find(" ."+a.filterGroupClass).each(function(e,f){c=jQuery(f);d=c.attr("data-to-filter");var g=c.attr("field-type"),h=[];c.find("input").each(function(b,c){c=jQuery(c);var e=c.val(),f=e.toLowerCase().trim();switch(g){case "keyword":if(1<f.length)for("undefined"===typeof a.cfinc[d]&&(a.cfinc[d]=[]),e=f.split(","),f=e.length,b=0;b<f;b++)innerValueToMatch=innerInputVal=e[b].trim(),1<innerValueToMatch.length&&(a.cfinc[d].push({vtm:innerValueToMatch,ival:innerInputVal}),
h.push(innerValueToMatch));break;case "tag":case "checkbox":c.is(":checked")&&("undefined"===typeof a.cfinc[d]&&(a.cfinc[d]=[]),h.push(f),a.cfinc[d].push({vtm:f,ival:e}));break;case "favourites":c.is(":checked")?("undefined"===typeof a.cfinc[d]&&(a.cfinc[d]=[]),a.cfinc[d].push({vtm:f,ival:e}),h.push(f),a.myTableHolder.addClass(a.hasFavouritesInFilterClass)):a.myTableHolder.removeClass(a.hasFavouritesInFilterClass);break;case "number":e=parseFloat(c.val());jQuery.isNumeric(e)&&0!==e&&("undefined"===
typeof a.cfinc[d]&&(a.cfinc[d]=[]),h.push(c.attr("data-label")+e+" "),"undefined"===typeof a.cfinc[d][0]&&(a.cfinc[d][0]={}),a.cfinc[d][0][c.attr("data-dir")]=e);break;case "date":e=c.val().trim(),"0"!==e&&""!==e&&("undefined"===typeof a.cfinc[d]&&(a.cfinc[d]={}),h.push(c.attr("data-label")+e),a.cfinc[d][0][c.attr("data-dir")]=e)}});if("undefined"!==typeof a.cfinc[d]){var n=c.find("label."+a.groupLabelClass).text();b+='<li class="category"><strong>'+n+":</strong> <span>"+h.join("</span><span>")+"</span></li>"}});
var e=a.myTableHolder.find("."+a.currentSearchFilterClass);if(!0===(0<Object.keys(a.cfinc).length?!0:!1)){var b="<ul>"+b+"</ul>",f=e.attr("data-title");"string"===typeof f&&0<f.length&&(b="<h3>"+f+"</h3>"+b);a.myTableHolder.addClass(a.hasFilterClass).removeClass(a.doesNotHaveFilterClass)}else b=e.attr("data-no-filter-text"),a.myTableHolder.removeClass(a.hasFilterClass).addClass(a.doesNotHaveFilterClass);e.html(b)},retrieveLocalCookie:function(){"undefined"!==typeof Cookies&&(a.myfavs=Cookies.getJSON("myfavs"),
...
a.split("=");a=c[0];c=c[1]&&decodeURIComponent(c[1]);(b[a]=b[a]||[]).push(c)}),"undefined"!==typeof b.load&&(c=!0,a.myTable.addClass(a.loadingClass),jQuery.getJSON(a.serverConnectionURL+"load/"+b.load+"/",function(b){var c=!1;b=b.Data;b=JSON.parse(b);for(var f in b)b.hasOwnProperty(f)&&(a[f]=b[f],a.serverDataToApply[f]=!0,"myfavs"===f&&(c=!0));a.processRetrievedData(c);a.myTable.removeClass(a.loadingClass)}).fail(function(){a.processRetrievedData();a.myTable.removeClass(a.loadingClass)})));!1===c&&
a.processRetrievedData()},processRetrievedData:function(b){if("undefined"!==typeof a.serverDataToApply.myfavs&&!0===a.serverDataToApply.myfavs){a.myTableBody.find("tr."+a.favouriteClass).removeClass(a.favouriteClass);for(var c in a.myfavs)a.myfavs.hasOwnProperty(c)&&a.myTableBody.find("#"+a.myfavs[c]).addClass(a.favouriteClass);0<a.myfavs.length?a.myTableHolder.addClass(a.hasFavouritesClass):a.myTableHolder.removeClass(a.hasFavouritesClass);!0===b&&(a.myTableHolder.hasClass(a.hasFavouritesInFilterClass)&&
a.myTableHolder.find(a.showFavouritesSelector).click(),a.myTableHolder.find(a.showFavouritesSelector).click());delete a.serverDataToApply.myfavs}"undefined"!==typeof a.serverDataToApply.cfinc&&!0===a.serverDataToApply.cfinc&&(a.createFilterForm(),a.applyFilter(),delete a.serverDataToApply.cfinc);"undefined"!==typeof a.serverDataToApply.csort&&!0===a.serverDataToApply.csort&&(b=a.csort.scat,c=a.csort.sdir,a.myTableHead.find(a.sortLinkSelector).removeClass(a.sortAscClass).removeClass(a.sortDescClass),
...
jQuery.fn.isOnScreen=function(){var g,u;g=jQuery(window).scrollTop();u=g+jQuery(window).height();var p,n;p=this.offset().top;n=p+this.outerHeight();return p<=u&&n>=g};(function(g){var u=g.fn.on,p;g.fn.on=function(){var g=Array.apply(null,arguments),a=g[g.length-1];if(isNaN(a)||1===a&&g.pop())return u.apply(this,g);var b=g.pop(),c=g.pop();g.push(function(){var a=this,e=arguments;clearTimeout(p);p=setTimeout(function(){c.apply(a,e)},b)});return u.apply(this,g)}})(jQuery);
