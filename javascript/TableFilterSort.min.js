 ...
 * 2013/07/26
**/
(function(b){var a=b.fn.on,c;b.fn.on=function(){var e=Array.apply(null,arguments);var g=e[e.length-1];if(isNaN(g)||(g===1&&e.pop())){return a.apply(this,e)}var d=e.pop();var f=e.pop();e.push(function(){var h=this,i=arguments;clearTimeout(c);c=setTimeout(function(){f.apply(h,i)},d)});return a.apply(this,e)}}(this.jQuery));